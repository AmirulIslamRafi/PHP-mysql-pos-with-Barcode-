					...
					<table class="mt-5">
						<tbody>
							...
							<tr>
								...
								<td class="pl-5 pb-1"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-phone"></i></span></div><input type="text" name="number" pattern='^([01]|\+88)?\d{11}' title='Phone Number (Format: +8801716819073)' class="form-control-sm form-control" value="<?php echo $row['contact_number'];?>" required></div></td>
							</tr>
							<tr>
								<td>Change Photo:</td>
